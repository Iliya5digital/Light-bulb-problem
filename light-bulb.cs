...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine($"Расходы на освещение первого помещения: {expensesRoom1} рублей");
        Console.WriteLine($"Расходы на освещение второго помещения: {expensesRoom2} рублей");
    }
}
